...
## Project Structure
    ...
    ├── testapiautosetting_123885  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123885`
...
2. Clone this repo and `cd testapiautosetting_123885`
